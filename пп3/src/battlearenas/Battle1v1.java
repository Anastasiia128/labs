...
import droid.Healer;
import droid.Sniper;
import droid.Soilder;
import droid.Stats_info;
import droid.Tank;
    ...
    public static Droid createDroid(char player, Scanner read) {
        ...
        while(true) {
            ...
            switch (option) {
                ...
                case 5 -> System.out.println(Stats_info.stats1v1());
                default -> System.out.println("Error: wrong option. Please try again...");
            }
        }
    }
    ...
    public static void playerMove(char player, Droid droid1, Droid droid2, Scanner read) {
        ...
        if(droid1.getType().equals("Healer")) {           // якщо дроїд - хіллер
            ...
            if(droid1.isUltimate()) {         // якщо дроїд не хіллер і в нього є ульт.
                ...
                option = read.nextInt();
                switch (option) {
                    case 1 -> droid1.damages(droid2);
                    case 2 -> droid1.ultimateAbility1v1(droid2);
                    default -> {
                        System.out.println("Wrong option! Try again.");
                        playerMove(player, droid1, droid2, read);
                    }
